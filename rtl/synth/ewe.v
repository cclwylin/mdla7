...
module ewe #(
    ...
    localparam [3:0] PH_LANE_PIPE    = 4'd3;
    localparam [3:0] PH_PACK         = 4'd4;
    ...
    wire [31:0] payload_read_cycles = ceil_div(read_bytes, READ_PORTS * PAYLOAD_BYTES) + 32'd1;
    wire [31:0] lane_pipe_cycles = compute_cycles + 32'd2;
    wire [31:0] payload_write_cycles = ceil_div(write_bytes, WRITE_PORTS * PAYLOAD_BYTES) + 32'd1;
    ...
    assign l1_req_bytes = (phase_id == PH_PAYLOAD_WRITE) ? write_bytes : read_bytes;
